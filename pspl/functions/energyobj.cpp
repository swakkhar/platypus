/*!
	@file hpmodel/energyobj.cpp
	@brief The implementation file for EnergyObj class.
	@details This is the implementation file for EnergyObj class.
...
#include "pspl/functions/energyobj.hpp"
...
/*!
	The constructor
*/
EnergyObj::EnergyObj(Conf const & theConf,B const NeedHint) : Function(theConf.SysHdl(), NeedHint)
{
	WatchError
...
/*!
	The duplicator.
*/
EnergyObj::EnergyObj(EnergyObj const & that) : Function(that)
{
	WatchError
...
/*!
	The assigner.
*/
EnergyObj const & EnergyObj::operator = (EnergyObj const & that)
{
	WatchError
